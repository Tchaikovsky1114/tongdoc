  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.diagnosisStatusBox}>
        ...
        <>
        <Image style={{width:52,height:52,marginRight:24}} source={require(`../../assets/diagnosis/status0.png`)} />
        <View>
        ...
        <Image style={{width:52,height:52,marginRight:24}} source={require(`../../assets/diagnosis/status5.png`)} />
        <View>
