...
export default function CertificationInProgress() {
  ...
  return (
    <WebView source={{uri:PASS_URL}} originWhitelist={['*']} onMessage={receiveCertificationSuccessFromWebviewHandler} onError={receiveCertificationFailedFromWebviewHandler} style={{flex:1}} />
  )
}
