    ...
    return (
      ...
      <View style={styles.summaryBox}>
        <View style={styles.familyChargeBox}>
          <P_12R style={{textAlign:'center'}} >통신비 ({familyCount}인)</P_12R>
          <P_16M style={{textAlign:'center'}}>{totalCharge} <Text style={{color:'#666666',fontSize:12}}>원</Text></P_16M>
        </View>
        <View style={styles.saveChargeBox}>
          ...
          <P_16M style={{color:'#FF3A3A',textAlign:'center',alignItems:'center',justifyContent:'flex-start'}}>
            ...
            <View style={{width:4}} />{totalSavings} <Text style={{color:'#666666',fontSize:12}}>원</Text>
          </P_16M>
        </View>
      </View>
      </>
...
const styles = StyleSheet.create({
  ...
  familyChargeBox:{
    borderRightWidth:1,borderRightColor:'#ddd', paddingHorizontal:26.5,paddingVertical:10
  },
  saveChargeBox:{
    paddingHorizontal:26.5,paddingVertical:10
  },
})